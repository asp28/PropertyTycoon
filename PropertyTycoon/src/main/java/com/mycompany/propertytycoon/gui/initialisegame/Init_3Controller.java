 ...
 * @author ankeet
 */
public class Init_3Controller implements Initializable {

    @FXML
    private Button confirm, back;

    @FXML
    private ListView<String> p1_list, p2_list, p3_list;

    @FXML
    private TextField p1_name, p2_name, p3_name;
