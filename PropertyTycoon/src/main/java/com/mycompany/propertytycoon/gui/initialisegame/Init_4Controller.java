 ...
 * @author ankeet
 */
public class Init_4Controller implements Initializable {
    ...
    @FXML
    private ListView<String> p1_list, p2_list, p3_list, p4_list;

    @FXML
    private TextField p1_name, p2_name, p3_name, p4_name;
