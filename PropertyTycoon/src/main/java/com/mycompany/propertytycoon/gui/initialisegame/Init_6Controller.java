 ...
 * @author ankeet
 */
public class Init_6Controller implements Initializable {
    ...
    public boolean uniqueToken() {
        ...
        String p6 = p6_list.getSelectionModel().getSelectedItem();
    ...
    public boolean checkNames() {
        ...
        if (p1_name.getText().isEmpty()) {
            ...
            notEmpty = false;
        } else if (p6_name.getText().isEmpty()) {
            notEmpty = false;
        }
