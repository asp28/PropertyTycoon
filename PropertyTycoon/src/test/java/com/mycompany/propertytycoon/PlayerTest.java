...
public class PlayerTest {
     ...
     */
/**
 @Test public void testRoundTheBoard() throws IOException, InvalidFormatException {
 ArrayList<Integer> a = new ArrayList<Integer>();
 a.add(1);
 PropertyCards propertyCards = new PropertyCards("test", "green", "", true, 1000, "10", a, 100);
 ArrayList<PropertyCards> properties = new ArrayList<PropertyCards>();
 ...
 */
/**
 @Test public void testBuy() throws IOException, InvalidFormatException {
 Dice dice = new Dice();
 Board board = new Board();
 Bank bank = new Bank(board.getBoardLocations());
 Token token = Token.CAT;
 ...
 @Test public void testToken() throws IOException, InvalidFormatException{
 Dice dice = new Dice();
 Board board = new Board();
 Bank bank = new Bank(board.getBoardLocations());
 Token token = Token.CAT;
